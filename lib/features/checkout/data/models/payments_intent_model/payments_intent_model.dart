...
class PaymentsIntentModel {
  ...
  factory PaymentsIntentModel.fromJson(Map<String, dynamic> json) {
    return PaymentsIntentModel(
...
//           ? List<dynamic>.from(json['payment_method_types'])
//           : null,
